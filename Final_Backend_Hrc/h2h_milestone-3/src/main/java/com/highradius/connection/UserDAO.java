...
public class UserDAO {
    ...
    private static String jdbcPassword = "pratik";
    ...
    private static final String SELECT_ALL_USERS = "SELECT Sl_no, CUSTOMER_ORDER_ID, SALES_ORG, DISTRIBUTION_CHANNEL, CUSTOMER_NUMBER, COMPANY_CODE, ORDER_CURRENCY, AMOUNT_IN_USD, ORDER_CREATION_DATE FROM h2h_oap ORDER BY Sl_no DESC LIMIT 100";
    private static final String DELETE_USERS_SQL = "DELETE FROM h2h_oap WHERE Sl_no=?";
    private static final String UPDATE_USERS_SQL = "UPDATE h2h_oap SET SALES_ORG=?, DISTRIBUTION_CHANNEL=? WHERE Sl_no=?";
